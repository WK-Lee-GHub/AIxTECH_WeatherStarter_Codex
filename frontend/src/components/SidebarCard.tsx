  ...
  return (
    ...
    >
      <button
        ...
        className="absolute right-2 top-2 z-10 flex h-7 w-7 items-center justify-center rounded-full border border-white/10 bg-black/20 text-white/65 transition hover:border-rose-200/30 hover:bg-rose-500/30 hover:text-white focus:outline-none focus:ring-2 focus:ring-white/40 disabled:cursor-wait disabled:opacity-50"
      >
